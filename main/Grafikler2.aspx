<%@ Page Title="" Language="C#" MasterPageFile="~/Ogrenci.Master" AutoEventWireup="true" CodeBehind="Grafikler2.aspx.cs" Inherits="WebApplication6.Grafikler2" %>
       ...
       <table class="table table-bordered table-hover">
            <tr>
                <td>
                    ...
                    <asp:Chart ID="Chart1" runat="server" Width="761px" Height="400px" OnLoad="Chart1_Load">
                        <Series>
            ...
            <tr>
                ...
                <td>
                     <h5>Vize Notları</h5>
                    <asp:Chart ID="Chart4" runat="server"  Width="700px" Height="400px">
                        <Series>
